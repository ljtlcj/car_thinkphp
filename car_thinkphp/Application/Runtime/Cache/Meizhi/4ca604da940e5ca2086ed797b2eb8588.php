...
<html style="background: #f0f0f0;">
	<head>
		...
		<link rel="stylesheet" href="/Public/Meizhi/css/delete_stafs.css" />
		<script type="text/javascript" src="/Public/Meizhi/js/jquery-2.1.1/jquery.min.js" ></script>
		<script type="text/javascript" src="/Public/Meizhi/js/delete_stafs.js" ></script>
	</head>
	<body >
		<form action="" method="post" style="width:1030px ;height: 400px;">
			<div style="width: 100%;height: 100%;">
				...
				<div class="register1">
				<div class="div3">删除员工名称：<input type="text" placeholder="账号" class="search_name" name="search_name" style="cursor:text";/></div>
				</div>
