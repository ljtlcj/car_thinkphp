...
<html style="background: #f0f0f0;">
	...
	<body >
		<form action="<?php echo U('Staff/add');?>" method="post" style="width:1030px ;height: 400px;">
			<div style="width: 100%;height: 100%;">
				...
				<div class="register1">
				<div class="div3">注册员工账号：<input type="text" placeholder="账号" class="search_name" name="username" style="cursor:text";/></div>
				<div class="div4">注册员工密码：<input type="password" placeholder="密码" class="search_num" name="password" style="cursor:text"/></div>
				<div class="div5">确认员工密码：<input type="password" placeholder="确认密码" class="sure_password" name="sure_password" style="cursor:text"/></div>
				</div>
				<div class="search_button"><input type="submit" value="确定" name="search_submit" id="4" class="search_submit" /></div>
			</div>
		</form>
	</body>
</html>